...
```
java -Dspring.profiles.active=production -jar ./target/student-space-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=ma.um5/student-space
```
